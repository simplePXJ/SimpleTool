...
@implementation AdScrollSubView
{
    NSUInteger index;
    CGFloat margin;
    BOOL isBegin;
...
- (UILabel *)createLabel {
    ...
    label.backgroundColor = KColor.view_main_2;
